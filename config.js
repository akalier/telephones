...
if (configVariables.database == 'mySQL') {
    ...
    if (configVariables.count) {
        ...
        if (configVariables.percent === 0) {
            ...
            console.log(CLASS_NAME + ": " + "Executing mySQL COUNT with 0%.");
            ...
            console.log(CLASS_NAME + ": " + "Executing mySQL COUNT with 50%.");
        ...
        if (configVariables.percent === 0) {
            ...
            console.log(CLASS_NAME + ": " + "Executing mySQL ALL with 0%.");
        } else {
            const mysqlselect50 = require('./in_codes/mySQLselect50.js');
            performQueries = mysqlselect50.mysqlSelect50;
            console.log(CLASS_NAME + ": " + "Executing mySQL ALL with 50%.");
        }
    }
    ...
    if (configVariables.count) {
        ...
        if (configVariables.percent === 0) {
            ...
            console.log(CLASS_NAME + ": " + "Executing mongoDB ALL with 0%.");
        } else {
            const mongodbselect50 = require('./in_codes/mongoDBselect50.js');
            performQueries = mongodbselect50.mongoSelect50;
            console.log(CLASS_NAME + ": " + "Executing mongoDB ALL with 50%.");
        }
    }
